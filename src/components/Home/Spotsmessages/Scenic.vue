<template>
  <div id="Emitters">
    ...
    <el-dialog title :visible.sync="addVisible" style width="520px" :close-on-click-modal="false">
      ...
      >
        <el-form-item style="margin: 47px auto 30px;width: 330px;" label="厕所名称" prop="name">
          <el-input v-model="addForm.name" autocomplete="off"></el-input>
        </el-form-item>

        <el-form-item style="margin: 30px auto;width: 330px;" label="厕所位置" prop="address">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      queryapi: "/scenery/coordinate/selectCoordinate",
      delapi: "/scenery/coordinate/deleteCoordinate	",
      saveapi: "/scenery/coordinate/addCoordinate",
      updateapi: "/scenery/coordinate/updateCoordinate",
      scenerySpotId: "",
      editVisible: false,
      addForm: {
        name:'',
